        ...
        stage('Clone GitHub Repo') {
            steps {
                script {
                    ...
                    checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-token', url: 'https://github.com/Vijay-glitch495/RAG_MEDICAL_CHATBOT.git']])
                   // checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-token', url: 'https://github.com/Vijay-glitch495/RAG_MEDICAL_CHATBOT.git']])
                }
            }
        }
